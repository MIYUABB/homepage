...
function Footer() {
    return(
        <footer className="z-50 static mt-auto w-screen bg-shade-primary p-8 grid grid-cols-3 grid-rows-1 gap-3 text-text-col">
            ...
            <div className="m-auto">
                ...
                <a className="hover:underline" href="/me">Über mich</a><br/>
