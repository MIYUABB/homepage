...
function Article(props: { title: string , text: string, img: string, imgleft: boolean, alt:string }){
    ...
    return(
        <div className="mx-40 z-50 my-10">
            <div className="h-min grid grid-cols-2 bg-gradient-to-r from-shade-secondary to-shade-primary p-4 rounded-lg">
                ...
                <img src={require("../images/" + props.img)} alt={props.alt} className="rounded h-fit place-self-end max-h-96"/>
            </div>
        </div>
    )
}
