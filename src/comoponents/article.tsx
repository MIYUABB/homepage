...
function Article(props: { title: string , text: string, img: string, imgleft: boolean, alt:string }){
    if(props.imgleft) {
        return(
            <div className="mx-20 lg lg:mx-50 z-50 mt-10">
                <div className="h-min grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 bg-gradient-to-br from-shade-primary to-shade-secondary md:p-2 lg:p-4 rounded-lg">
                    <img src={require("../images/" + props.img)} alt={props.alt} className="rounded h-fit place-self-center lg:place-self-start max-h-96"/>
                    <div className="p-8 rounded w-fit h-fit place-self-center text-2xl lg:text-lg">
        ...
        return (
            <div className="mx-20 lg lg:mx-50 z-50 mt-10">
                <div className="h-min grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 bg-gradient-to-br from-shade-primary to-shade-secondary md:p-2 lg:p-4 rounded-lg">
                    ...
                    <img src={require("../images/" + props.img)} alt={props.alt} className="rounded h-fit place-self-center lg:place-self-end max-h-96"/>
                </div>
            </div>
        )
    }
