...
function Career() {
    ...
    return (
        <div className='flex flex-col min-h-screen bg-body-col'>
            ...
            <Article title="Kantonschule Hottingen" text='Ich habe die Informatikmittelschule(IMS) an der Kantonschule Hottingen(KSH) im Sommer 2025 abgeschlossen. Die IMS war für mich in der Sek der "Notfallplan", da ich mich zu der Zeit noch mehr für eine Lehrstelle interessierte. Jedoch war die IMS im Nachhinein besser als eine Lehrstelle, da ich zu bei meinen ehemaligen Sek-Freunden sehe, wie es in einer Lehre ist.' img="KSH_hof.jpg" imgleft={false} alt="Kantonschule Hottingen"/>
            <Footer />
        </div>
    );
}
